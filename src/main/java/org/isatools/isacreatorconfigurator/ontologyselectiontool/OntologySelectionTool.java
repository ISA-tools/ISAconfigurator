...
import org.isatools.isacreatorconfigurator.common.ClearFieldUtility;
...
import org.isatools.isacreatorconfigurator.ontologymanager.*;
...
public class OntologySelectionTool extends JFrame implements MouseListener,
    ...
    private ImageIcon ontologyLookupIcon, recentHistoryIcon, termDefinitionIcon,
            searchButton, searchButtonOver, filterInfo, okIcon, okOverIcon;
    ...
    private OntologyResultTree ontologySearchResults;
     ...
     *
     * @param consumer              - The parent DataEntryPanel
...
//		this.addWindowListener(this);
    ...
    private JPanel createSearchPanel() {
        ...
        searchField.setToolTipText("<html><b>Enter a term</b>, e.g. dose and click the search icon</html>");
        ...
        ontologySearchResults = new OntologyResultTree(top);
    ...
    private JPanel createSouthPanel() {
        ...
        JLabel selectTermLabel = UIHelper.createLabel("selected term(s)");

        termSelectionContainer.add(selectTermLabel);
        ...
        final JLabel ok = new JLabel(okIcon);
        ok.setOpaque(false);
                ...
                if (!searchField.getText().equals("")) {
                    try {
                        ...
                        reconstructTree();
                            ...
                            e) {
                        log.error("Failed to connect to OLS: " + e.getMessage());
                        e.printStackTrace();
                    } finally {
...
//
////		recommendedOntologies.put("EFO", new RecommendedOntology(new Ontology("1136", "42488", "EFO", "Array Express Experimental Factor Ontology"),
////				new OntologyBranch("http://www.ebi.ac.uk/efo/EFO_0000719", "temporal measurement")));
////
////		recommendedOntologies.put("ENVO", new RecommendedOntology(new Ontology("", "1.26", "ENVO", "Environment Ontology"),
////				new OntologyBranch("ENVO:00002985", "oil")));
//
//		recommendedOntologies.put("NCIt", new RecommendedOntology(new Ontology("1032", "42331", "NCIt", "NCI Thesaurus "),
//				new OntologyBranch("http://ncicb.nci.nih.gov/xml/owl/EVS/Thesaurus.owl#Firmicutes", "Firmicutes")));
//
//		OntologySelectionTool ost = new OntologySelectionTool(recommendedOntologies);
//		ost.createGUI();
//		ost.setVisible(true);
//		ost.requestFocusInWindow();
////		ost.setVisible(true);
//	}
}
