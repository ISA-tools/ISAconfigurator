...
public class CustomSplitPaneDivider extends BasicSplitPaneDivider {
    ...
    public static final Image SPLIT_ICON = new ImageIcon(CustomSplitPaneDivider.class.getResource("/images/effects/split_pane_icon.png")).getImage();
    public static final Image MIDDLE_SEPARATOR = new ImageIcon(CustomSplitPaneDivider.class.getResource("/images/effects/split_pane_separator.png")).getImage();

    protected final int ONE_TOUCH_SIZE = 20;
    protected int ONE_TOUCH_OFFSET = 0;
    int dividerSize = 20;
    ...
    public void paint(Graphics g) {
        Color bgColor = (UIHelper.BG_COLOR);
        ...
        if (bgColor != null) {
            ...
            g.drawImage(MIDDLE_SEPARATOR, 0, ((size.height / 2) - (MIDDLE_SEPARATOR.getHeight(null) / 2)), null);
            g.drawImage(SPLIT_ICON, 0, size.height - SPLIT_ICON.getHeight(null), null);
        }
        super.paint(g);
