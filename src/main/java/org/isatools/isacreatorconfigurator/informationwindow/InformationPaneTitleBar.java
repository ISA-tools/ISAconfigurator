...
public class InformationPaneTitleBar extends TitlePanel {


    private static final Image BG_GRADIENT = new ImageIcon(InformationPaneTitleBar.class.getResource("/images/information_window/background_active.png")).getImage();

    private JButton closeButton;

    private Image activeLogo;

    private Image inactiveLogo;
