...
public class CustomSpreadsheetCellRenderer extends DefaultTableCellRenderer {

    /**
     * Creates a SharpCellRenderer.
     */
    public CustomSpreadsheetCellRenderer() {
        super();
    }
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (hasFocus) {
            if (table.isCellEditable(row, column)) {
                ...
                super.setBackground(new Color(140, 198, 63, 175));
            }
        } else {
            setBorder(null);
        }
