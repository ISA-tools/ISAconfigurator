...
public class NCIThesaurusModifier implements Modifier {


    public String modifySearch(String searchTermToModify) {
        return searchTermToModify.substring(searchTermToModify.lastIndexOf("#") + 1);
    }
}
