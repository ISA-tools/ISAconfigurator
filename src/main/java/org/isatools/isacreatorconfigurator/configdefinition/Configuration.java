...
public class Configuration implements Serializable {
    ...
    private List<TableConfiguration> tableData;

    public Configuration(List<MappingObject> mappings) {
        this.mappings = mappings;
        tableData = new ArrayList<TableConfiguration>();
    }

    public void addTableObject(TableConfiguration to) {
        if (to != null) {
            tableData.add(to);
        }
    }
    ...
    public List<TableConfiguration> getTableData() {
        return tableData;
    }
}
