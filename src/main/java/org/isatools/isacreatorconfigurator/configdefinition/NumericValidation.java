...
/**
 * NumericValidation class accommodates the definition of validation on a numeric field to define contraints on it's
 * Values such as: it should fall between 0 and 100 or should be less than or equal to 1000 for example.
 *
 * @author eamonnmaguire
 * @date Aug 26, 2009
 */
public class NumericValidation<T> {
    ...
    public NumericValidation(ValidationTypes validationType, T value) {
        this.lowerBounds = value;
        this.validationType = validationType;
    }

    public NumericValidation(ValidationTypes validationType, T lowerBounds, T upperBounds) {
