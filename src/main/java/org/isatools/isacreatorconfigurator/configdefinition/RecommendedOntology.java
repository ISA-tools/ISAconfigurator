...
public class RecommendedOntology implements Serializable {

    private Ontology ontology;
    private OntologyBranch branchToSearchUnder;

    public RecommendedOntology() {
    }

    public RecommendedOntology(Ontology ontology) {
        this(ontology, null);
    }

    public RecommendedOntology(Ontology ontology, OntologyBranch branchToSearchUnder) {
        this.ontology = ontology;
        this.branchToSearchUnder = branchToSearchUnder;
    }

    public OntologyBranch getBranchToSearchUnder() {
        return branchToSearchUnder;
    }

    public void setBranchToSearchUnder(OntologyBranch branchToSearchUnder) {
        this.branchToSearchUnder = branchToSearchUnder;
    }
