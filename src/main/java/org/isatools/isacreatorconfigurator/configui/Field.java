...
public class Field {
    private String name = "";
    private List<Location> appearsIn;
    ...
    public Field() {
        appearsIn = new ArrayList<Location>();
    }

    public Field(String name, List<Location> appearsIn) {
        this.name = name;
        this.appearsIn = appearsIn;
    }

    public List<Location> getAppearsIn() {
        return appearsIn;
    }
    ...
    public void setAppearsIn(List<Location> appearsIn) {
        this.appearsIn = appearsIn;
    }
    ...
    public boolean isAssayDefault() {
        return isAssayDefault;
    }

    public void setAssayDefault(boolean assayDefault) {
        isAssayDefault = assayDefault;
    }

    public boolean isStudyDefault() {
        return isStudyDefault;
    }

    public void setStudyDefault(boolean studyDefault) {
        isStudyDefault = studyDefault;
    }

    public String getDefaultWizardTemplate() {
        return defaultWizardTemplate;
    }

    public void setDefaultWizardTemplate(String defaultWizardTemplate) {
        this.defaultWizardTemplate += defaultWizardTemplate;
    }

    public boolean isInvDefault() {
        return isInvDefault;
    }
