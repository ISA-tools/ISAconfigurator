...
public class StructuralElementInfo extends JLayeredPane implements Serializable {

    public StructuralElementInfo() {
        setLayout(new BorderLayout());
        JLabel headerLab = new JLabel(
                new ImageIcon(getClass()
                        .getResource("/images/general_gui/structuralElement.png")), JLabel.CENTER);
        add(headerLab, BorderLayout.NORTH);
        JLabel infoLab = new JLabel(
                new ImageIcon(getClass()
                        .getResource("/images/general_gui/structuralElementInfo.png")));
        infoLab.setOpaque(false);
        add(infoLab, BorderLayout.CENTER);
        setVisible(true);
    }
