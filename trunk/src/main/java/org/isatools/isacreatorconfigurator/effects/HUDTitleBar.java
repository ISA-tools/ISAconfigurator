...
public class HUDTitleBar extends JComponent {
    ...
    private Image backgroundGradient = new ImageIcon(getClass().getResource("/images/effects/title-background.png")).getImage();
    private Image backgroundGradientInactive = new ImageIcon(getClass().getResource("/images/effects/title-background-inactive.png")).getImage();
    private Image grip;
    private Image inactiveGrip;
    private Image close = new ImageIcon(getClass().getResource("/images/effects/title-close.png")).getImage();
    private Image closeInactive = new ImageIcon(getClass().getResource("/images/effects/title-close-inactive.png")).getImage();
    private Image closeOver = new ImageIcon(getClass().getResource("/images/effects/title-close-over.png")).getImage();
    private Image closePressed = new ImageIcon(getClass().getResource("/images/effects/title-close-pressed.png")).getImage();
    ...
    JButton createButton(final AbstractAction action,
                         final Image image,
    ...
    private class MouseInputHandler implements MouseInputListener {
        ...
        public void mousePressed(MouseEvent ev) {
            ...
            Point convertedDragWindowOffset = SwingUtilities.convertPoint(
                    w, dragWindowOffset, HUDTitleBar.this);
            ...
            if (HUDTitleBar.this.contains(convertedDragWindowOffset)) {
