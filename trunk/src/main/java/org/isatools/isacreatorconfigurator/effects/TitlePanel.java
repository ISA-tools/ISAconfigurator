...
public abstract class TitlePanel extends JComponent {
    ...
    protected int preferredHeight = 26;

    protected Image backgroundGradient;


    public TitlePanel() {
        ResourceInjector.get("config-ui-package.style").inject(this, true);
    }
    ...
    public TitlePanel(Image backgroundGradient) {
        this.backgroundGradient = backgroundGradient;
    }

    public void setBackgroundGradient(Image backgroundGradient) {
        this.backgroundGradient = backgroundGradient;
    }
    ...
    public void installListeners() {
        ...
        window.addWindowListener(getWindowHandler());
    }

    protected abstract void createButtons();

    protected static JButton createButton(final AbstractAction action,
                                          final Image image,
    ...
    protected void paintComponent(Graphics g) {
        ...
        drawComponents(g2, active);
    }

    protected abstract void drawComponents(Graphics2D g2d, boolean active);
    ...
    protected abstract WindowAdapter getWindowHandler();
