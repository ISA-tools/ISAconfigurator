...
public class ClearFieldUtility extends JLabel implements MouseListener {
    ...
    private static final ImageIcon CLEAR = new ImageIcon(ClearFieldUtility.class.getResource("/images/ontologyselectiontool/clear.png"));
    private static final ImageIcon CLEAR_OVER = new ImageIcon(ClearFieldUtility.class.getResource("/images/ontologyselectiontool/clear_over.png"));
