...
public class ContainerLocationAdaptor {

    public ContainerLocationAdaptor(Container parent, JFrame child) {
        child.setLocationRelativeTo(parent);
    }

    public ContainerLocationAdaptor(Container parent, JWindow child) {
        child.setLocationRelativeTo(parent);
    }
}
