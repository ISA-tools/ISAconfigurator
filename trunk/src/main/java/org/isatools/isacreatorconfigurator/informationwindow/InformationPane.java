...
public abstract class InformationPane extends JPanel {

    public final Dimension PANE_SIZE = new Dimension(250, 300);

    protected static final ImageIcon LOADING = new ImageIcon(InformationPane.class.getResource("/images/ontologyconfigurationtool/loading.gif"));
    ...
    public abstract void instantiateFrame();
    ...
    protected abstract void createButtonPane();
