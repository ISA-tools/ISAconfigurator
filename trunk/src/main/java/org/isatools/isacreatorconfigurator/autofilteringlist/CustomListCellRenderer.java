...
package org.isatools.isacreatorconfigurator.autofilteringlist;
 ...
 */
public class CustomListCellRenderer extends JComponent
        implements ListCellRenderer {
    static Color listForeground = UIHelper.DARK_GREEN_COLOR;
    static Color listBackground = UIHelper.BG_COLOR;
    ...
    public CustomListCellRenderer() {
        ...
        image = new JLabel(new ImageIcon(getClass()
                .getResource("/images/autofilteringlist/addRecordToSubform.png")));
